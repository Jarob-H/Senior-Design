...
low_button= tk.Button(master=window, text="LOW", command=low,height= 1,width=2, bg="blue",
    fg="white",padx=100, pady=100)
med_button= tk.Button(master=window, text="MED", command=med,height= 1,width=2, bg="blue",
    fg="white",padx=100, pady=100)
high_button= tk.Button(master=window, text="High", command=high,height= 1,width=2, bg="blue",
    fg="white",padx=100, pady=100)



off_button = tk.Button(master=window, text="OFF", command=end,height= 1,width=2, bg="red",
    fg="white",padx=100, pady=100)
